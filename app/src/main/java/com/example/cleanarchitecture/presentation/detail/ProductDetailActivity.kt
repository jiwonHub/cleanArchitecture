...
import com.example.cleanarchitecture.databinding.ActivityProductDetailBinding
import com.example.cleanarchitecture.extensions.load
...
internal class ProductDetailActivity : BaseActivity<ProductDetailViewModel, ActivityProductDetailBinding>() {
    ...
    private fun handleLoading() = with(binding){
        progressBar.isVisible = true // 로딩중일 때 로딩창 띄우기
    }

    private fun handleSuccess(state: ProductDetailState.Success) = with(binding){
        progressBar.isGone = true // 로딩창 없애기
